  ...
  return (
    <section id='about' className='min-h-screen flex items-center justify-center py-20'>
        <div className='max-w-3xl mx-auto px-4'>
            ...
            <div className='p-8'>
                <p className='rounded-xl mb-6 p-8 border border-[#8F8A76] hover:border-[#BE4732] hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] hover:-translate-y-1 transition-all'>
